...
const MATERIAL_FIELDS: ReadonlyArray<{
  ...
  {
    field: "weight",
    read: (facts): string | null => facts.weightGramsDecimal,
    isFinancial: true,
  },
  {
    field: "purity",
    read: (facts): string | null =>
      `${facts.purityCode}:${facts.purityCatalogVersion}:${facts.purityFactorDecimal}`,
    isFinancial: true,
  },
  {
    field: "purchasePrice",
    read: (facts): string | null => facts.purchasePriceDecimal,
    isFinancial: true,
  },
  {
    field: "purchaseCurrency",
    read: (facts): string | null => facts.purchaseCurrency,
    isFinancial: true,
  },
  {
    field: "purchaseDate",
    read: (facts): string | null => facts.purchaseDate,
    isFinancial: true,
  },
  {
    field: "physicalForm",
    read: (facts): string | null => facts.physicalForm,
    isFinancial: false,
  },
];
