...
interface CommonTranslations {
  ...
  readonly currency_names: Readonly<Record<CurrencyType, string>>;
...
interface OnboardingTranslations {
  ...
  readonly pitch_slide_voice_count: string;
  readonly pitch_slide_voice_transcript: string;
  readonly pitch_slide_voice_result_coffee_title: string;
  readonly pitch_slide_voice_result_coffee_category: string;
  readonly pitch_slide_voice_result_clothes_title: string;
  readonly pitch_slide_voice_result_clothes_category: string;
  readonly pitch_slide_voice_result_borrowed_title: string;
  readonly pitch_slide_voice_result_borrowed_category: string;
  readonly pitch_slide_voice_review_ready: string;
  readonly pitch_slide_voice_result_coffee_accessibility: string;
  readonly pitch_slide_voice_result_clothes_accessibility: string;
  readonly pitch_slide_voice_result_borrowed_accessibility: string;
