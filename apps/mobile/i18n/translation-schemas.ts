...
export const metalsTranslationSchema = NamespaceSchema.and(
  z.object({
    ...
    add: z.object({
      ...
      physical_form: z.string(),
      notes: z.string(),
      notes_placeholder: z.string(),
      estimated_value: z.string(),
      estimate_unavailable: z.string(),
      local_first: z.string(),
      submit: z.string(),
      submitting: z.string(),
      ...
      rate_fresh: z.string(),
      rate_stale: z.string(),
      rate_unknown: z.string(),
      rate_freshness_unknown: z.string(),
      rate_age_unavailable: z.string(),
      rate_observation_unavailable: z.string(),
      rate_just_now: z.string(),
      rate_unavailable: z.string(),
      pure: z.string(),
      per_pure_gram: z.string(),
      estimated_gain_since_purchase: z.string(),
      estimated_loss_since_purchase: z.string(),
      rates_updated: z.string(),
      metal_rate_label: z.string(),
      fx_rate_label: z.string(),
      unknown_rate_source: z.string(),
      unknown_rate_quality: z.string(),
      validation: z.object({
        required: z.string(),
        invalid: z.string(),
        non_positive: z.string(),
        precision: z.string(),
        currency_precision: z.string(),
        out_of_range: z.string(),
        unsupported_metal: z.string(),
        unknown_purity: z.string(),
        future_date: z.string(),
      }),
    }),
    edit: z.object({
      title: z.string(),
      ...
      what_will_change: z.string(),
      previous: z.string(),
      current: z.string(),
      history_note: z.string(),
      current_value_stays: z.string(),
