...
3. Load and analyze the implementation context:
   ...
   - **IF mockup-backed UI is in scope**: locate the approved references through
     ...
     `.agent/workflows/mockup-implementation.md`. Treat fidelity-affecting
     `UNKNOWN` metadata as a pre-implementation blocker rather than guessing.
...
9. Completion validation:
   ...
   - For every such mockup-backed UI surface, require a rendered baseline
     ...
     responsive, dark, RTL/Arabic, and enlarged-text variant in scope under the
   ...
   - Report **functional status** and **visual fidelity status** separately for
     mockup-backed UI. A functionally complete feature may still be visually
     incomplete.
   - Treat this visual-evidence requirement as N/A only when the implementation
     contains no changed UI governed by an approved mockup.
