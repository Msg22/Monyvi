...
| US7-M05 | Injected local batch failure                                                    | Confirm, observe failure, retry                                                | No partial state/evidence/history change remains; retry reuses action identity and succeeds                                         | Yes        | SQLite/hook Green                                       |
