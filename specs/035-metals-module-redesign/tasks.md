...
- [ ] T044 Implement exact-once holding reconciliation, incomplete retry/locking, immutable rate references, and name/notes-only LWW in `apps/mobile/services/metal-reconciliation-service.ts`, `apps/mobile/services/metal-rate-reference-service.ts`, and `apps/mobile/services/metal-metadata-service.ts`
