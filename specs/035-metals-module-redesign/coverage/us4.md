...
- The Edit SQLite command suite is 7/7 against the real WatermelonDB test schema, including metadata LWW, mixed correction clocks, legacy metadata, replay, and terminal policy.
